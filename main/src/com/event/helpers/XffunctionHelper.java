...
public class XffunctionHelper {
	...
	public static String getXfSelectListBox(String ref, String[] values, String[] captions, String defval){  
	...
	public static String getXfSelectOneCombo(String ref, String[] values, String[] captions,String defval){
