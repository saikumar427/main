...
public class AccountLevelReportsJsonHelper {
	...
	public static String getTransactionReportsJson(ArrayList<HashMap<String,String>> transactionMap,ArrayList Fields
		...
		try {
			ArrayList <String>noSortable=new ArrayList<String>(
					Arrays.asList("TN","TP","TC","CCPF","SF","TTC","TNet","Di","CSF","No","NTSC","VTSC","ESF","ECCF","Bal","OCCF"));
   ...
   int id=0;
      ...
      while (entries.hasNext()) {
        ...
        else
        {
            ...
            {
                if(value.length()>6 && !glbtemphmap.containsKey(value))
                {
