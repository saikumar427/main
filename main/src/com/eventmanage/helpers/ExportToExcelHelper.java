...
public class ExportToExcelHelper {
	...
	public static String exportToExcel(ArrayList<HashMap<String, String>> mapList,ArrayList fieldNames, 
			String type,String exporttype,HashMap<String,String> customAttribsMap,HashMap<String,String> reportsColumnMap,HashMap<String, String> ebeeI18nMapping ){
		...
		if (mapList!=null&&mapList.size()>0){
			...
			for(int colindex=0;colindex<fieldNames.size();colindex++){
				...
				if(reportsColumnMap.containsKey(fieldNm))
					fieldNm=I18n.getString(reportsColumnMap.get(fieldNm));
			...
			for(int i=0;i<mapList.size();i++){
		       ...
		       for(int k=0; k<fieldNames.size();k++){
	    		   ...
	    		   if(ebeeI18nMapping.containsKey(fieldValue))
	    			   fieldValue=I18n.getString(ebeeI18nMapping.get(fieldValue));
