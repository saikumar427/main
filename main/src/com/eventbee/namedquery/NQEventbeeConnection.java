...
public class NQEventbeeConnection  {
	...
	Connection con=null;
		try{
			//System.out.println("**** trying to connect default connection****");
	...
	Connection con=null;
		try{
			//System.out.println("****trying to connect named connection: "+name+" ****");
	...
	private static String getDSName(String modulename){
		return NQEbeeConstantsF.get(modulename,null);
	}
