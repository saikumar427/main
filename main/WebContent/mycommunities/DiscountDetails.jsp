...
<tr>
<td valign="top">Codes List *<br/><span class="smallestfont">(Comma Separated)</span></td>
...
<td><s:iterator value="%{allitems}" var="ticket">
<s:checkbox name="selitems" fieldValue="%{key}" value="%{selitems.contains(key)}" />${value}<br/>
</s:iterator>
</td>
</tr>
