...
document.getElementById('form-register-event').action="../ccprocessing/ccvalidateaction.jsp";
...
<div id='center'>
<form name='form-register-event'  id="form-register-event" action="../ccprocessing/ccvalidateaction.jsp"  method="post"   >
<s:hidden name="userId"></s:hidden>
<s:hidden name="creditCardData.amount"></s:hidden>
<s:hidden name="creditCardData.seqId"></s:hidden>
...
<tr>
<td>
<s:text name="creditCardData.creditCardScreenData"></s:text>
</td>
</tr> 
</table> 
</td></tr>
...
<table align="center">
<tr><td align="center">
<input type="button" value="Submit" onClick="AjaxSubmit('submit');"/>
</td>
<td align="center">
<input type="button" value="Cancel" onClick="AjaxSubmit('cancel');"/>
</td></tr> 
</table> 
</td></tr>  
</table>
