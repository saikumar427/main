...
<form id="eventinformation" method="post" name="eventinformation" action="../fbauth/publisheventtofb.jsp" onsubmit="validateeventinformation(); return false;">
...
<input type="hidden" name="eventurl" id="eventurl"  value="" >
