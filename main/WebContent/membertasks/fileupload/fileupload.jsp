...
<!--  <s:fielderror theme="simple"/>-->
 <form  action="FileUpload!save" method="POST" enctype="multipart/form-data" id="fileUploadForm" name="fileUploadForm" class="form-horizontal" >
<s:hidden name="eid" ></s:hidden>
<s:hidden name="listId" id="listId"></s:hidden>
<s:hidden name="purpose" ></s:hidden>
<s:hidden name="priFldCount"></s:hidden>
