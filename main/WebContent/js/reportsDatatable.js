...
(function( factory ) {
	...
	else if ( jQuery && !jQuery.fn.dataTableReports ) {
...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( lang )
	{
		...
		if ( ! lang.sEmptyTable && zeroRecords &&
			defaults.sEmptyTable === "None Found" )
		{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sEmptyTable": props.global_none_found_msg2,
			 ...
			 *    } );
			 */
			"sInfo": props.pagination_showing_lbl+" _START_ to _END_ of _TOTAL_ "+props.pagination_entries,
			 ...
			 *    } );
			 */
			"sInfoEmpty": props.pagination_showing_lbl+" 0 to 0 of 0 "+props.pagination_entries,
	...
	$.extend( DataTable.ext.classes, {
		...
		"sInfo": "dataTables_info col-md-2 sub-text bottom-gap",
		"sPaging": "dataTables_paginate col-md-10 sub-text paging_", /* Note that the type is postfixed */
		...
		/* Scrolling */
		"sScrollWrapper": "dataTables_scroll bottom-gap",
	...
	$.extend( DataTable.ext.oJUIClasses, DataTable.ext.classes, {
		...
		/* Features */
		"sPaging": "dataTables_paginate sub-text fg-buttonset ui-buttonset fg-buttonset-multi "+
