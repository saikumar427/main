...
var jsonFormat="{";
	...
	jsonFormat=jsonFormat+"}";
	new Ajax.Request('/volume/embedded_reg/profileticketstatus.jsp?timestamp='+(new Date()).getTime(),{
	method: 'get',
...
function gettkttimer(){
	...
	div.setAttribute('style','right:131px;padding:1px;font-size:11px;');
...
var t=document.getElementById('tid').value;
	new Ajax.Request('/volume/embedded_reg/seating/delete_temp_locked_tickets.jsp?timestamp='+(new Date()).getTime(), {
	method: 'post',
