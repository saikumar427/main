...
var nicEditorConfig = bkClass.extend({
	...
	buttonList : ['save','bold','italic','underline','left','center','right','justify','ol','ul','fontSize','fontFamily','fontFormat','indent','outdent','image','link','unlink','forecolor','bgcolor','upload'],
...
// commenting for not displaying upload image button in nice editor.
...
var nicUploadButton = nicEditorAdvancedButton.extend({
    nicURI: "/main/membertasks/ImageUpload!saveImageWUSIWUG",
