...
if(mins_left==-1) {
	...
	document.getElementById('time_left_tobuy').innerHTML='<center>'+props.time_out+'</center>';
...
function gettimeoutpopup(msg){
	...
	var divpopupcontent=props.sorry_time_out+"<br><input type='button' value='"+props.try_again+"' onclick='timeouttkt()'><a href=# onclick=timeouttkt()><img src='/home/images/images/close.png' class='divimage'></a>";
