...
function gettkttimer(){
	$("ticket_timer").style.display='block';
...
function gettimeoutpopup(msg){
	...
	//var divpopupcontent="<br><ul><li>Sorry, timed out!</li></ul><br><input type='button' value='Try Again' onclick='timeouttkt()'><a href=# onclick=timeouttkt()><img src='/home/images/images/close.png' class='divimage'></a>";
	var divpopupcontent="<br><ul><li>Sorry, timed out!</li></ul><center><input type='button' value='Try Again' onclick='timeouttkt()'><center><a href=# onclick=timeouttkt()><img src='/home/images/close.png' class='divimage'></a>";
	//$("").attr("tabindex", "-1");;;
...
if(discountfalgpro=='false')
{
var dismsg="Applied Code Is Unavailable <br/><br/><br/>";
