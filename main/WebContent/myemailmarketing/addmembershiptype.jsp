...
<s:form name="addmembershiptypeform" action="CommunityManage!saveMembershipType" method="post" theme="simple">

<s:hidden name="groupId"></s:hidden>
<s:hidden name="membershipData.memberShipId"></s:hidden>
<br/>
<div class="taskbox">
<span class="taskheader">Membership Type Details</span><br/>
<div>
...
<td><s:textfield name="membershipData.memberShipName" theme="simple" size="80"></s:textfield></td>
</tr> 
<tr>
<td >Description</td>
<td>
<s:textarea name="membershipData.description" rows="10" cols="76"></s:textarea>
</td>
</tr> 
<tr>
