...
<input type='hidden' name='buyerupdate'  value='yes' />
...
<br/>
 ...
 <div class="col-md-3 col-sm-3 col-xs-3" style=" margin-right: 63px;"></div>
                        <div class="col-md-6 col-xs-6 col-sm-6">
                            <button type="button" name='update' id='updaprofile' class="btn btn-primary" onclick="updateProfileData('buyer');"><s:text name="global.submit.btn.lbl"></s:text></button>
                            <button class="btn btn-cancel" name="cancel" id="cancelregdetails" onclick="closeTransactionTickets();"><i class="fa fa-times"></i></button>
                        </div>
                    </div>
