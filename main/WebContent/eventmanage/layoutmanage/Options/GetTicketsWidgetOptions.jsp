...
$(function(){
	...
	$('.savebtn').on('click',function(){
	    ...
	    savebutton.html(props.pg_widgets_saving_lbl);
		savebutton.attr('disabled','disabled');
		$.getJSON('SaveSettings?type=widgetOptions&eid=<%=eventid%>&widgetid=<%=widgetid%>&ref_title=Registration',{
...
<div class="col-md-12 col-xs-12 col-sm-12 ">
	...
	<div class="col-md-10 col-sm-10 col-xs-12 form-group">
		<input type="text" name="title" value="<%=title%>" id="tkttitle" size="30" />
	</div>
	</div>
	</form>
