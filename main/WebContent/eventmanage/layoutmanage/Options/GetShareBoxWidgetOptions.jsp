...
<%@page import="com.eventbee.layout.DBHelper,java.util.ArrayList,com.eventbee.general.GenUtil,com.eventbee.general.EbeeConstantsF"%>
...
String eventname=DBHelper.getEventinfo(eventid).get("eventname");
...
$(function(){
  ...
  var getTitle=function(){
	...
	$('.savebtn').on('click',function(){
		...
		savebutton.html(props.pg_widgets_saving_lbl);
		savebutton.attr('disabled','disabled');
		$.getJSON('SaveSettings?type=widgetOptions&eid=<%=eventid%>&widgetid=<%=widgetid%>&ref_title=Share Box',{
