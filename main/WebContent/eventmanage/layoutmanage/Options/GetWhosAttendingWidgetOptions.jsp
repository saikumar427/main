...
System.out.println("whosattdata: "+whosattdata);
...
$(function(){
	...
	//var keywords="<div class='text-center'><b>"+props.pg_whos_attending_lbl+"</b></div><br>";
	var keywords= '';
   for(var i=0;i<totalQuestions.length;i++){
	...
	$('.savebtn').on('click',function(){
		...
		savebutton.html(props.pg_widgets_saving_lbl);
		savebutton.attr('disabled','disabled');
		$.getJSON("SaveSettings?type=widgetOptions&eid=<%=eventid%>&widgetid=<%=widgetid%>&ref_title=Who's Attending",{
