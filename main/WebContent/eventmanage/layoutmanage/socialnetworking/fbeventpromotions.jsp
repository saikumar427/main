...
<script type="text/javascript" src="/home/js/paging.js"></script>
<head>
  <style>
  #promotionsbox{
...
<%
	...
	out.println("</tr></table>");
		...
		param=new String[]{eid};
			...
			out.println("<div>");
			out.println("<table id='eventprotab' style='width:100%'>");
			...
			%>
			<%-- <div class="col-xs-12" id='promotionsbox'>
				<div class="col-xs-2"><a href='<%=profileurl%>' target='_blank'><img src='<%=src%>' border='0' title='<%=name%>' alt=''></a></div>
				<div class="col-xs-10"><a href='<%=profileurl%>' target='_blank'><%=name%></a> promoted on <%=day%></div>
			</div><div class="col-xs-12"><hr></div> --%>
				 <%-- <tr><td>
					<table class="table" id='promotionsbox'>
			<tr>     <td ><a href='<%=profileurl%>' target='_blank'><img src='<%=src%>' border='0' title='<%=name%>' alt=''></a> 
				</td><td width="5"></td><td> <a href='<%=profileurl%>' target='_blank'><%=name%></a> promoted on <%=day%></td>
			</tr>
