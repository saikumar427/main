...
<s:form id="ontriggerreachemailform" name="ontriggerreachemailform" action="GroupTicketConfirmationEmail!save" method="post" theme="simple">
<s:hidden name="eid" id="eid"></s:hidden>
<s:hidden name="emailpurpose" id="emailpurpose" value="ontriggerreach"></s:hidden>
