...
<s:form id="ontriggerfailemailform" name="ontriggerfailemailform" action="GroupTicketConfirmationEmail!save" method="post" theme="simple">
<s:hidden name="eid" id="eid"></s:hidden>
<s:hidden name="emailpurpose" id="emailpurpose" value="ontriggerfail"></s:hidden>
