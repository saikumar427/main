...
<html>
	<head>
		 ...
		 <link href="/main/bootstrap/css/bootstrap-social.css" rel="stylesheet"> 
				...
				<div class="col-md-12 col-lg-12" style="background-color:#f1f5f7 !important;">
					...
					<div class="col-md-4" style="padding: 48px;background-color:#fff;">
						<div class="row">
							...
							<div align="center"> <img class="img-responsive" width="300px" height="200px" border="0" src="/main/bootstrap/images/bishop.jpg" alt="BISHOP SCHOOL" > </div>
							</div>
						</div><br>
