...
<div class="row" style="padding-top:50px !important;padding-bottom:25px !important; background-color:#fff !important;">
	<div class="col-xs-12">
		<div class="panel-heading" style="border:none !important;color: #58585a; text-align:center;">
...
<div class="row" style="background-color:#fff !important;">
	<div class="col-xs-12">
		<div class="panel-heading" style="border:none !important;color: #58585a; text-align:center;">
			<span style="color: #999999;font-size: 42px;">Do you host events</span>
		</div>
	</div>
	<div class="container">
		<div class="col-md-12 col-sm-12 col-xs-12 text-center" style="margin-bottom: 35px;">
			<a href="/main/user/signup">
				<input type="button" class="btn btn-primary  btn-lg" value="Sign Up" />
			</a>
		</div>
	</div>
</div>
