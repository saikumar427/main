...
<div style="width: 100%; background-color: #F3F6FA" class="container">
	<div class="container" style="padding-bottom: 50px; padding-top: 50px;">
		...
		<div class="row">
			...
			<a href="/main/pricing/es-mx" target="_blank">http://www.eventbee.com/main/pricing</a>
			</p>
		...
		<div class="row">
			<div class="col-md-12 normal_desc_grey_ans">
				<div calss="features-ticketing">
					...
					<div class="col-md-12"style="margin:20px 0px!important;"><img class="img-responsive" src="/main/images/es-co/Ticket_settings.jpg" alt="Free online event registration software - Ticket settings"></div>
					...
					<div class="col-md-12"style="margin:20px 0px!important;"><img class="img-responsive" src="/main/images/es-co/Payment_settings.jpg" alt="Free online event registration software - Payment settings"></div>
		...
		<br>
		<div class="row">
			<div class="col-md-12 caption_header_blue_faq">Software de Registro de Eventos Gratuito + Recaudo de Tarifas Adicionales</div>
		</div>
		<br>
		<div class="row">
			<div class="col-md-12 normal_desc_grey_ans">
				<div calss="features-ticketing">
					<p>
También puedes recaudar tarifas adicionales de parte de los asistentes al evento por medio de la venta de tiquetes y de la transacción. 
</p>			
					<p>Para recoger tarifas adicionales por medio de la venta de tiquetes, establece tarifas más altas que la comisión de Eventbee en  &quot;Configuración de Tiquetes&quot;. Los honorarios adicionales recogidos irán a tu cuenta.</p>
					<p>Para recaudar tarifas adicionales por medio de transacciones, establece tarifas más altas al costo de procesamiento de tu proveedor elegido en &quot;Ajustes de Pago&quot;. </p>
