	...
	<div class="container" style="padding-bottom: 50px; padding-top: 50px;">
		<div class="row">
			<div class="col-md-3">
				...
				<div class="main_header_orange">COP3.000</div>
			...
			<div class="col-md-3">
				...
				<div class="main_header_orange">COP4.500</div>
				<div class="normal_desc_grey">/TIQUETE</div>
			</div>
			<div class="col-md-3">
				<div id="advanced">
				...
				<div class="main_header_orange">COP6.000</div>
				<div class="normal_desc_grey">/TIQUETE</div>
			</div>
			<div class="col-md-3">
				<div id="business">
				...
				<div class="main_header_orange">COP10.000</div>
				<div class="normal_desc_grey">/TIQUETE</div>
				<div class="normal_desc_grey"></div>
			</div>
		</div>
