				...
				<div class="col-md-10 normal_desc_grey_ans">
					<ol class="pricing_desc_grey u"
						...
						<li><span class="">1)</span> Regístrate para obtener una cuenta gratuita en 
							<a href="/main/user/signup?lang=es-co" target="_blank">http://www.eventbee.com/main/user/signup</a></li>
...
Para una descripción más detallada acerca de cómo funciona Eventbee, visita nuestra página web  <a href="/main/how-it-works/es-co"
			...
			<div class="row">
				<div class="col-md-12 normal_desc_grey_ans">
					<b>Tarifa Fija de Servicio</b><br> Para realizar la Venta de Tiquetes más sencilla, nuestra tarifa es de un dólar por boleto vendido, independientemente del precio del Tiquete. No hay costos porcentuales adicionales como en otras compañías. Para obtener más detalles, por favor visita <a href="/main/pricing/es-co" target="_blank">
